...
export default Ember.Component.extend({
  ...
  classNames: ['proficiency', 'domain-proficiency-matrix'],
  ...
  drawChart(data) {
    ...
    component.$('#render-domain-proficiency-matrix').empty();
    const svg = d3
      .select('#render-domain-proficiency-matrix')
      .append('svg')
      .attr('width', width)
      .attr('height', height);
  ...
  blockChartContainer(selectedCompetency) {
    ...
    container += '</div>';
    component.$('#render-domain-proficiency-matrix').prepend(container);
  },
  ...
  reduceChartHeight() {
    ...
    let height = component.get('isTaxonomyDomains')
      ...
      : 50;
    component.$('#render-domain-proficiency-matrix').height(height);
    component.$('#render-domain-proficiency-matrix svg').attr('height', height);
  },
