...
import {COMPETENCY_NAVIGATION_MENUS,COMPETENCY_NAVIGATION_MENUS_INDEX} from 'admin-dataview/config/config';
...
export default Ember.Component.extend(ConfigurationMixin, {
  ...
  */
  activeMenuIndex: Ember.computed(function() {
    let activeMenuIndex = COMPETENCY_NAVIGATION_MENUS_INDEX[Utils.getRoutePathLastOccurrence()];
